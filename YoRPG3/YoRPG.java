...
public class YoRPG {
  ...
  public void newGame() {
    ...
    try {
      classchoose = in.readLine();
    }
    catch ( IOException e ) { }
    System.out.println(classchoose);
    if (classchoose.equals("Mage")){
      
      pat = new Mage( name );}
    if (classchoose.equals("Rogue")){
      
      pat = new Rogue( name );}
    if (classchoose.equals("Archer")){
      pat = new Archer( name );}
    if (classchoose.equals("Gunner")){
      
      pat = new Gunner( name );}
    if (classchoose.equals("Warrior")){
